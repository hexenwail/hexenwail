...
// detonates.  e9731510a made it a thrown bouncing bomb and d39212a12 then made
// it orbit the caster, both to "fix" that, but uhexen2-9uzt disassembled all
// three shipped builds (retail data1, retail portals, Storm Over Thyrion) and
// found drop-and-detonate is the intended design -- and SoT, the mod the
// report came from, ships its own progs.dat that shadows this one regardless.
// Do not reinstate.  (uhexen2-qj8s)
void TimeBombBoom()
{
	sound(self,CHAN_AUTO,"misc/warning.wav",1,ATTN_NORM);
	DarkExplosion();
