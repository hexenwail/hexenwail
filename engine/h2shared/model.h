...
/* MAX_SKIN_HEIGHT, MAXALIASVERTS and ALIAS_BASE_SIZE_RATIO deliberately are
 * NOT redefined here (alextnewman/hexenwail 0b1906add does, because its web
 * build has no software-renderer headers).  They belong to the rasterizer:
