...
static const char pp_frag_src[] =
	...
	"\n"
	"    if (softemu > 0) {\n"
	"        float alpha = color.a;  /* Preserve alpha for transparency/particles */\n"
	"        vec3 c = color.rgb;\n"
	"        /* Only dither opaque surfaces; skip dither for semi-transparent to avoid brightening portals */\n"
