...
static const char cull_mark_src[] =
	...
	"    if (!planeback && d < -0.01) return; */\n"
	"\n"
	"    /* Frustum cull disabled — PVS provides sufficient visibility\n"
	"     * bounds. Tight AABB frustum tests cause surface popping at\n"
	"     * view edges. GPU clip hardware handles off-screen tris. */\n"
	"\n"
