...
1. **Bindless textures** — resolved by removal in 8124ed055 (uhexen2-ubsu). Not a parity gap: Ironwail does not use `ARB_bindless_texture`. See uhexen2-im9g for the two preconditions (a measured need, and hardware that can test it) before anyone tries again.
